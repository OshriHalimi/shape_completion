...
function [ output_args ] = mriReorientDir( prefix )
%MRIREORIENTDIR is a utility that will not be featured in the final release
%
    dirStruct = dir;
    ...
    for i=1:size(dirName)
        ...
        if dirIsDir{i}==0
            ...
            if strcmp(ext, '.img')
                ...
                uporient = mriReorient(temp);
                save([prefix name '.mat'],'uporient');
...
%   Head should be pointing up after rotation

...
def parser():
    ...
    p.add_argument('--exp_name', type=str, default='amass_template_based_architecture_exp', help='The experiment name. Leave empty for default')
...
def train_main():
    banner('Network Init')
    nn = F2PEncoderDecoderTBased(parser())  # TODO - Change me Oshri
    nn.identify_system()

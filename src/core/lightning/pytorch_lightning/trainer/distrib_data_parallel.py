...
.. code-block:: python
    ...
    # let's enable optimizing over the number of layers in the lightning
...
class TrainerDDPMixin(ABC):
    ...
    def set_distributed_mode(self, distributed_backend, num_gpu_nodes):
        ...
        log.info(f'GPU Available: {torch.cuda.is_available()} | Using GPU: {self.on_gpu}')  # MANO
    ...
    def set_nvidia_flags(self, is_slurm_managing_tasks, data_parallel_device_ids):
        ...
        log.info(f'Visible GPU IDs: [{os.environ["CUDA_VISIBLE_DEVICES"]}]')  # MANO

...
from lightning.pytorch_lightning.overrides.data_parallel import (
...
class TrainerIOMixin(ABC):
    ...
    def __init__(self):
        ...
        self.resume_cfg = None  # MANO ADDED
    ...
    def restore_training_state(self, checkpoint):
        ...
        if self.resume_cfg[0] and self.early_stop_callback is not None and self.early_stop_callback is not False:

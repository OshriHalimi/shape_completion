...
mask_path = '/run/user/1000/gvfs/smb-share:server=132.68.36.59,share=data/ShapeCompletion/Mixamo/Projections/MPI-FAUST/050/Boxing/018/4.npz'
mesh_path = '/run/user/1000/gvfs/smb-share:server=132.68.36.59,share=data/ShapeCompletion/Mixamo/Blender/MPI-FAUST/050/Boxing/018.obj'

pc = trimesh.load(mesh_path, 'obj')
V = np.array(pc.vertices)
F = np.array(pc.faces)

mask = np.load(mask_path)
mask = mask['mask']
plot_mesh(V[mask,:], strategy='spheres')
